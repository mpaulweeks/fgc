...
<html lang="en">
<head>
    % include('_header.tpl', title='Goodbye')
</head>
<body>
...
<div class="col-md-8 text-left">
    ...
    <p> Most of all, big big thanks to everyone who ever emailed or tweeted me. <br/>
    Whether it was a bug, complaint, idea, or just saying hi, I appreciated every single message. <br/>
    It was your feedback and encouragement that kept the site running. I will forever cherish the experience &#60;3 </p>

    <br/>
    <p class="text-center"> So long, and thanks for all the fish!<br/>
    M. Paul Weeks </p>
</div>
<div class="col-md-2">
</div>
